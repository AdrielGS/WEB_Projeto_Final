...
public function add(){
		ob_start();
		include 'questoesController.class.php';
		$conteudo = ob_get_contents();
		ob_end_clean();
		$tamOpcoes = count($opcoes);
		$query_questao = DB::conn()->prepare("INSERT INTO __questoes_questoes (value, type, difficulty, subject, tag) VALUES ($question, $type, $difficulty, $subject, $tag,)");
